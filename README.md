...
- `services/portrait-templates.ts`：26 套 AI 原创写真模板与自拍要求，覆盖职场、韩式、日系、复古、礼服、东方、港风、法式、户外、四季、旅拍、艺术、男士和常用证件照风格
...
- 生成链路记录请求解析、模板读取、Gemini 生成、结果解析、服务端总耗时和浏览器往返耗时；成功页显示耗时明细，Vercel 日志输出 `portrait_generation_timing` 结构化记录
